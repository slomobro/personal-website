...
- **Hero photo (optional)** — the hero is currently a hand-drawn SVG dusk-meadow
  scene with swallows. If you'd rather use a real nature photograph (like the
  barn-swallow inspiration), we can drop one in behind the title.
